...
function About() {
  ...
  return (
    <div className="bg-[url(/background.webp)] bg-cover bg-center relative py-12 px-4 flex md:justify-start justify-center items-center flex-col">
      <div className="grid grid-cols-1 md:grid-cols-3 px-8 gap-12">
        ...
        <div className="col-span-2">
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="text-seiza-cuaternario font-normal text-[35px] text-balance text-start mb-8"
          >
            {isEn
          ...
          <div className="md:flex">
            <motion.p
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, ease: "easeOut" }}
              className="text-seiza-cuaternario font-normal text-[35px] text-balance text-start"
            >
              {isEn
            ...
            <img src="/about_image.png" className="h-96" />
          </div>
        </div>
      </div>
    </div>
